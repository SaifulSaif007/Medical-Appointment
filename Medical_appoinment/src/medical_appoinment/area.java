...
public class area extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
         ...
         try{
            ...
            PreparedStatement patm = conn.prepareStatement("select * from area\n" +
                                "where a_name =?  and a_id =? and doc_id =?") ;
            
                patm.setString(1, jTextField1.getText());
                patm.setString(2, jTextField2.getText());
                patm.setString(3, jTextField3.getText());
            ...
            if(rs.next()){
                ...
                PreparedStatement pat = conn.prepareStatement("insert into area (a_name,a_id,doc_id) values(?,?,?)" );
